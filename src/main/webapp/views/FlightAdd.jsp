...
<body>
<form:form modelAttribute="flightDTO" action="${pageContext.request.contextPath}/flight/create" method="post"
    ...
    <form:input type="file" path="travelImage"/><br>
    <form:errors path="travelImage" cssClass="error"/><br>
